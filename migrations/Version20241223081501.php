 ...
 */
final class Version20241223081501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "order" (id SERIAL NOT NULL, customer_id INT NOT NULL, status SMALLINT NOT NULL, details JSON NOT NULL, PRIMARY KEY(id))');
